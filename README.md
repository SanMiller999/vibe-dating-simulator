...
## Синхронный счётчик сообщений — v1.3.3
...
## Исправление виджета и непрочитанных сообщений — v1.3.3
...
## Сворачиваемые настройки виджета — v1.3.3
...
## Navigation icon scale and badge placement — v1.3.3
...
## Единый визуальный размер иконок — v1.3.3
...
## Счётчики внутри приложения — v1.3.3
