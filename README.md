...
## Синхронный счётчик сообщений — v1.3.1
...
## Исправление виджета и непрочитанных сообщений — v1.3.1
...
## Сворачиваемые настройки виджета — v1.3.1
...
## Navigation icon scale and badge placement — v1.3.1
...
## Единый визуальный размер иконок — v1.3.1
...
## Счётчики внутри приложения — v1.3.1
